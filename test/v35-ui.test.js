...
const checks = [
  ...
  ['landing is a minimal two-route chooser with shared appearance', /class="routes"/.test(landing) && /id="modeToggle"/.test(landing) && /los\.v25\.surface/.test(landing) && (/loan-suite\.html/.test(landing)||/app=suite(?:&|&amp;)tab=quote/.test(landing)) && (/income-calculator\.html/.test(landing)||/app=income(?:&|&amp;)tab=w2/.test(landing))],
