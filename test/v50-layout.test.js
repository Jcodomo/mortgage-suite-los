...
const checks=[
  ['Loan Suite working canvas matches the 1320px Income Calculator canvas',/\.cols-main\{[\s\S]*?width:min\(1320px,calc\(100% - 40px\)\)[\s\S]*?max-width:1320px[\s\S]*?margin:0 auto/.test(css)],
